...
<body>
                                    ...
                                    <tbody>
                                        <tr>
                                            <?php if ($value["id_employ_tujuan"] == NULL) { ?>
                                                ...
                                                <td class="text-center">
                                                    <button type="button" class="btn btn-sm btn-primary push" data-toggle="modal" data-target="#modal-block-large" id=<?php echo $value["id_task"]?> onclick="showdetail(this,'request');">Launch Modal</button>
    ...
    <!-- script ambil data task -->
    <script>
    function showdetail(button,table){
        var id_task = button.id;
        $("#id_task").text(id_task);
    }
    </script>
    <!-- akhir script ambil data task -->
    <!-- akhir tujuan pop up detail -->
